...
return new class extends Migration
{
    ...
    {
        Schema::create('mission_event_staff_submissions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['mission_event_id', 'staff_id'], 'mission_staff_submission_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('mission_event_staff_submissions');
    }
};
