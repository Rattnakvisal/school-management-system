document.addEventListener('DOMContentLoaded', () => {
    const dataNode = document.getElementById('staff-dashboard-data');
    const workloadCanvas = document.getElementById('staffWorkloadChart');
    const calendarRoot = document.getElementById('staff-dashboard-calendar');
    const calendarLabel = document.getElementById('staff-dashboard-calendar-label');
    const slots = Array.from(document.querySelectorAll('.js-staff-slot'));
    ...
    try {
        ...
        console.error('Unable to parse staff dashboard data.', error);
        dashboardData = {};
    }
    ...
    const setStatusClass = (element, mode) => {
        ...
        element.className = 'js-staff-slot-status teacher-lesson__status';
    ...
    const updateRealtimeSchedule = () => {
        ...
        slots.forEach((slot) => {
            ...
            const statusEl = slot.querySelector('.js-staff-slot-status');
    ...
    if (workloadCanvas && typeof window.Chart !== 'undefined') {
        ...
        if (!prefersReducedMotion) {
            ...
            const step = (now) => {
                ...
                animatedProgressValue = progressValue * easeOutCubic(progress);
