                                                        ...
                                                        <td class="whitespace-nowrap px-3 py-3 text-slate-600">
                                                            @php
                                                                $slotClasses = $subject->studySchedules
                                                                    ->map(
                                                                        fn($slot) => $slot->schoolClass?->display_name,
                                                                    )
                                                                    ->filter()
                                                                    ->unique()
                                                                    ->values();
                                                            ...
                                                            <div x-show="open" x-cloak
                                                                ...
                                                                <div
                                                                    ...
                                                                    <form method="POST"
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                for="edit_description_{{ $subject->id }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const syncHiddenFromContainer = (container, startInput, endInput) => {
                ...
                const firstSlot = readSlotsFromContainer(container).find((slot) => slot.start_time && slot
                    .end_time);
            ...
            const renderSlots = (container, slots) => {
                ...
                const html = normalizedSlots.map((slot, index) => buildSlotRowHtml(namePrefix, index, slot))
                    .join('');
