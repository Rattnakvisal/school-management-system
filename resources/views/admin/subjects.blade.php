...
@section('page')
    @php
        ...
        $subjectStatCards = [
            ...
            [
                ...
                'badgeTone' => 'bg-amber-50 text-amber-700 dark:text-amber-300 ring-amber-100',
                'showPercent' => true,
                'progressText' =>
                    $subjectTotal > 0
    ...
    <div class="subject-stage space-y-6">
        ...
        @if (session('success'))
            <div class="subject-reveal rounded-2xl border border-emerald-200 bg-emerald-50 dark:border-emerald-900/50 dark:bg-emerald-900/20 dark:border-emerald-900/50 dark:bg-emerald-900/20 px-4 py-3 text-sm font-semibold text-emerald-700 dark:text-emerald-300"
                style="--sd: 2;">
                {{ session('success') }}
            </div>
        @endif
        ...
        @if (session('error'))
            <div class="subject-reveal rounded-2xl border border-red-200 bg-red-50 dark:border-red-900/50 dark:bg-red-900/20 dark:border-red-900/50 dark:bg-red-900/20 px-4 py-3 text-sm font-semibold text-red-700 dark:text-red-300"
                style="--sd: 2;">
                {{ session('error') }}
            </div>
        @endif
        ...
        @if ($errors->subjectCreate->any())
            <div class="subject-reveal rounded-2xl border border-red-200 bg-red-50 dark:border-red-900/50 dark:bg-red-900/20 dark:border-red-900/50 dark:bg-red-900/20 px-4 py-3 text-sm text-red-700 dark:text-red-300"
                style="--sd: 2;">
        ...
        <div class="grid gap-6 xl:grid-cols-12">
            <section x-data="{
                ...
                class="subject-reveal subject-float rounded-3xl border border-slate-100 bg-white/95 p-5 shadow-sm ring-1 ring-slate-200 dark:border-slate-700 dark:bg-slate-800/50 dark:ring-slate-700 xl:col-span-4"
                style="--sd: 3;">
            ...
            <section
                class="subject-reveal subject-float rounded-3xl border border-slate-100 bg-white/95 p-5 shadow-sm ring-1 ring-slate-200 dark:border-slate-700 dark:bg-slate-800/50 dark:ring-slate-700 xl:col-span-8"
                style="--sd: 4;">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="mt-3 space-y-3 text-sm">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <span
                                                                                    class="font-semibold {{ $subject->is_active ? 'text-emerald-700 dark:text-emerald-300' : 'text-rose-700' }}">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="mt-3 flex flex-wrap gap-1.5">
                                                                                @forelse ($subjectPreviewStudents as $student)
                                                                                    <span
                                                                                        class="inline-flex items-center rounded-full border border-emerald-200 bg-emerald-50 dark:border-emerald-900/50 dark:bg-emerald-900/20 dark:border-emerald-900/50 dark:bg-emerald-900/20 px-2.5 py-1 text-[11px] font-semibold text-emerald-700 dark:text-emerald-300">
                                                                                        {{ $student->name }}
                                                                                    </span>
                                                                                @empty
