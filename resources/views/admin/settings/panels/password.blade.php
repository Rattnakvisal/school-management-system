                    <section data-settings-panel="password" class="hidden space-y-6">
                        <form method="POST" action="{{ route('admin.settings.password.update') }}"
                            ...
                            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Use a strong password with at
                                least 8 characters.</p>

                            <div class="mt-5 space-y-4">
                                <div>
                                    <label for="current_password"
                                        class="mb-1 block text-xs font-semibold text-slate-600 dark:text-slate-400">Current
                                        Password</label>
                                ...
                                <div class="grid gap-4 md:grid-cols-2">
                                    <div>
                                        <label for="password"
                                            class="mb-1 block text-xs font-semibold text-slate-600 dark:text-slate-400">New
                                            Password</label>
                                    ...
                                    <div>
                                        <label for="password_confirmation"
                                            class="mb-1 block text-xs font-semibold text-slate-600 dark:text-slate-400">Confirm
                                            Password</label>
