<section data-settings-panel="feature-page" class="hidden space-y-6">
    @if ($homePageReady ?? false)
        <form method="POST" action="{{ route('admin.settings.feature-page.update') }}" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Badge, headline, and tag shown above the feature cards.
                            </p>
                        </div>
                ...
                <div class="px-6 pb-6 pt-7 sm:px-7">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Cards displayed in the Platform Features section.
                            </p>
                        </div>
                    ...
                    <div class="mt-4 grid gap-3 xl:grid-cols-2">
                        @for ($i = 0; $i < $platformFeatureLimit; $i++)
                            @php
                                ...
                                $showPlatformFeature =
                                    filled($platformFeatureTitle) || filled($platformFeatureDescription);
                            @endphp
                            ...
                            <div data-home-editor-card data-addable-card="platform-features"
                                ...
                                <div class="mb-2 flex flex-wrap items-center justify-between gap-2">
                                    <span class="flex items-center gap-2 text-xs font-bold text-slate-500">
                                        <span
                                            class="grid h-6 w-6 place-items-center rounded-full bg-sky-600 text-[11px] text-white">
                                            {{ $i + 1 }}
                                        </span>
                                    ...
                                    <div data-home-card-actions class="flex flex-wrap items-center gap-2">
                                        ...
                                        <label
                                            ...
                                            <input type="hidden" name="feature_cards[{{ $i }}][active]"
                                                value="0">

                                            <input type="checkbox" name="feature_cards[{{ $i }}][active]"
                                ...
                                <label
                                    ...
                                    <input name="feature_cards[{{ $i }}][color]" type="color"
                                        value="{{ $platformFeatureColor }}"
