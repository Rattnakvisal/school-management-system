                                ...
                                @forelse ($students as $student)
                                    <tr class="align-top hover:bg-slate-50/80" x-data="{ open: false }">
                                        ...
                                        <td class="px-3 py-3 align-top text-slate-600">
                                            <div class="whitespace-nowrap text-slate-600">{{ $student->email }}</div>
                                        </td>
                                        <td class="px-3 py-3 align-top text-slate-600">
                                        ...
                                        <td class="px-3 py-3 align-top text-slate-500">
                                            <span class="whitespace-nowrap">{{ $student->created_at->format('M d, Y') }}</span>
                                        </td>
                                        <td class="px-3 py-3 align-top">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            @if ($hasClassColumn)
                wireClassDependentFields(
                    ...
                    @if ($hasMajorSubjectColumn) document.getElementById('major_subject_id') @elsenull @endif,
                    @if ($hasClassStudyTimeColumn) document.getElementById('class_study_time_id') @elsenull @endif
                        );
                ...
                document.querySelectorAll('[id^="edit_school_class_id_"]').forEach((classSelect) => {
                    ...
                    wireClassDependentFields(
                        classSelect,
                        @if ($hasMajorSubjectColumn) document.getElementById(`edit_major_subject_id_${suffix}`) @elsenull @endif,
                        @if ($hasClassStudyTimeColumn) document.getElementById(`edit_class_study_time_id_${suffix}`) @elsenull @endif
                            );
                });
            @endif
