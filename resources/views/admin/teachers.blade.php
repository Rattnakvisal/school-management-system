    ...
    <div class="teacher-stage admin-management-page teacher-page mx-auto max-w-[1500px] space-y-6 pb-8 text-slate-900 dark:text-slate-100">
        ...
        <div x-data="{ createOpen: @js($showCreateFormOnLoad) }"
            ...
            <section x-show="createOpen" x-cloak x-transition.opacity.duration.150ms
                ...
                aria-modal="true" aria-labelledby="create-teacher-title"
                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            <h2 id="create-teacher-title" class="text-2xl font-black text-slate-950 dark:text-white">
                                Create Teacher
                            </h2>
