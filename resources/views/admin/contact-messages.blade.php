                        ...
                        <div class="flex h-full flex-col">
                            <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                                ...
                                <div class="flex items-center gap-4">
                                    <a href="{{ route('admin.contacts.index') }}" class="text-sm font-semibold text-slate-500 hover:text-slate-700">
                                        Clear All
                                    </a>
                            ...
                            <form method="GET" action="{{ route('admin.contacts.index') }}" class="flex min-h-0 flex-1 flex-col"
