    ...
    <div class="student-stage space-y-6">
                        ...
                        <article class="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <span
                                    ...
                                    {{ \Illuminate\Support\Str::plural('slot', $slotCount) }}
                                </span>
                            </div>
        ...
        <section x-data="{ subjectFilterOpen: false }"
            ...
            <aside x-show="subjectFilterOpen" x-cloak x-transition:enter="transition ease-out duration-200"
                ...
                <form method="GET" action="{{ route('student.subjects.index') }}" class="flex min-h-0 flex-1 flex-col"
                    @submit="subjectFilterOpen = false">
                                    ...
                                    <tr class="{{ $row['is_today'] ? 'bg-emerald-50/45' : 'hover:bg-slate-50/80' }}">
                                        ...
                                        <td class="student-col-details px-3 py-3 align-top">
                                            <div class="space-y-1.5">
                                                <div
                                                    class="student-schedule-details text-xs leading-relaxed text-slate-600">
                                        ...
                                        <td class="student-col-teacher px-3 py-3 align-top text-slate-700">
                                            ...
                                            @if (!empty($row['teacher_email']))
                                                <div class="student-email text-xs text-slate-500">
                                                    {{ $row['teacher_email'] }}
                                                </div>
                                            @endif
                                        </td>
