...
<body class="page-boot min-h-screen bg-slate-50 text-slate-900" x-data="{
    ...
    <div class="relative overflow-hidden" id="home">
        ...
        <!-- FOOTER -->
        <footer class="bg-white-500 text-black-500">
                ...
                <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            <h3 class="text-lg font-bold text-black-500">{{ $schoolName }}</h3>
                        </div>

                        <p class="mt-4 text-sm leading-relaxed text-black-400">
                    ...
                    <!-- Quick Links -->
                    <div>
                        <h4 class="mb-4 text-black-500 font-semibold">Quick Links</h4>
                        <ul class="space-y-3 text-sm">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <a href="#about" class="hover:text-black-500 transition">About Us</a>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <a href="#programs" class="hover:text-black-500 transition">Programs</a>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <a href="#news" class="hover:text-black-500 transition">News & Events</a>
                            </li>
                    ...
                    <!-- Admissions -->
                    <div>
                        <h4 class="mb-4 text-black-500 font-semibold">Admissions</h4>
                        <ul class="space-y-3 text-sm">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <a href="#admission" class="hover:text-black-500 transition">Apply Now</a>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <a href="#requirements" class="hover:text-black-500 transition">Requirements</a>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <a href="#fees" class="hover:text-black-500 transition">Tuition Fees</a>
                            </li>
                    ...
                    <!-- Contact -->
                    <div>
                        <h4 class="mb-4 text-black-500 font-semibold">Contact Us</h4>
                        <ul class="space-y-4 text-sm text-black-400">
